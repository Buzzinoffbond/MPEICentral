...
<p class="pagination">
	...
	<?php if ($first_page === FALSE): ?>
		<?php echo __(''); ?>
	<?php else: ?>
		<a href="<?php echo HTML::chars($page->url($first_page)); ?>" rel="first"><?php echo __('&laquo;'); ?></a>
	<?php endif; ?>

	<?php if ($previous_page === FALSE): ?>
		<?php echo __(''); ?>
	<?php else: ?>
		<a href="<?php echo HTML::chars($page->url($previous_page)); ?>" rel="prev"><?php echo __('&larr;'); ?></a>
	<?php endif; ?>
	...
	<?php if ($next_page === FALSE): ?>
		<?php echo __(''); ?>
	<?php else: ?>
		<a href="<?php echo HTML::chars($page->url($next_page)); ?>" rel="next"><?php echo __('&rarr;'); ?></a>
	<?php endif ?>

	<?php if ($last_page === FALSE): ?>
		<?php echo __(''); ?>
	<?php else: ?>
		<a href="<?php echo HTML::chars($page->url($last_page)); ?>" rel="last"><?php echo __('&raquo;'); ?></a>
	<?php endif; ?>
